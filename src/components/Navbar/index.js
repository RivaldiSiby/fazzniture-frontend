      ...
      return (
         <Fragment>
            <div className={page === 'home' ? 'navbar header-navbar' : 'navbar'}>
               ...
               >
                  <div className="navbar-1">FAZZNITURE</div>
               </div>
               <div className="navbar-2 col-12 col-md-4">
                  <div
                     className={page === 'home' ? 'navbar-2-content navbar-underline' : 'navbar-2-content'}
                     onClick={() => {
                        navigate('/');
                     }}
                  >
                  ...
                  <div className={page === 'pages' ? 'navbar-2-content navbar-underline dropdown' : 'navbar-2-content dropdown'}>
                     ...
                     <div className="dropdown-content">
                        <div
                           className="dropdown-content-child"
                           onClick={() => {
                              navigate('');
                           }}
                        >
                  ...
                  <div
                     className={page === 'blog' ? 'navbar-2-content navbar-underline' : 'navbar-2-content'}
                     onClick={() => {
                        navigate('/blog');
                     }}
                  >
               ...
               <div className="navbar-3 col-12 col-md-4">
                  <div>
                     <img
                        src={require('../../assets/vector/Vector-Search.png')}
                        alt="Search"
                        className="navbar-3-logo"
                        onClick={() => {
                  ...
                  <div>
                     <img
                        src={require('../../assets/vector/Vector-Love.png')}
                        alt="Love"
                        className="navbar-3-logo"
                        onClick={() => {
                           navigate('/wishlist');
                  ...
                  <div>
                     <img
                        src={require('../../assets/vector/Vector-Cart.png')}
                        alt="Cart"
                        className="navbar-3-logo"
                        onClick={() => {
                           navigate('/cart');
               ...
               <form className={this.state.search ? 'navbar-search-container' : 'navbar-search-container-none'}>
                  ...
                  />
                  <img
                     src={require('../../assets/vector/Vector-Search-White.png')}
                     alt="Search"
